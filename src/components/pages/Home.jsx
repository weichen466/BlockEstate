...
const Home = () => {
  ...
  return (
    <React.Fragment>
      <Header />
      <h2>How to invest and trade in real estate with BlockEstate?</h2>
      <div className="container">
        <div className="content">
          ...
          <img
            ...
            alt="wallet"
          />
          <p>Connect your wallet to BlockEstate</p>
        </div>
        <div className="content">
          <h3>
      ...
      <div className="ad">
        ...
        <div className="adcontainer">
          ...
          <div className="adcontent">
            <i className="fas fa-check fa-checker" />
            <h3>No management</h3>
            <p>Don't worry, BlockEstate takes care of everything.</p>
          </div>
        </div>
      </div>
      <h3>
        How <span className="cl-blue">BlockEstate</span> works?
      </h3>
      <div className="how">
